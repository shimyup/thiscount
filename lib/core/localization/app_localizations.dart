...
// ── Onboarding ──────────────────────────────────────────────────────────────
  ...
  String get inboxFilterSectionCategory => _t({
    ...
    'pt': '🎁 Categoria', 'ru': '🎁 Категория', 'tr': '🎁 Kategori',
    'ar': '🎁 الفئة', 'it': '🎁 Categoria', 'hi': '🎁 श्रेणी', 'th': '🎁 หมวดหมู่',
  });

  String get inboxFilterSectionIndustry => _t({
    'ko': '🏷 산업', 'en': '🏷 Industry', 'ja': '🏷 業種', 'zh': '🏷 行业',
    'fr': '🏷 Secteur', 'de': '🏷 Branche', 'es': '🏷 Industria',
    'pt': '🏷 Indústria', 'ru': '🏷 Отрасль', 'tr': '🏷 Sektör',
    'ar': '🏷 الصناعة', 'it': '🏷 Settore', 'hi': '🏷 उद्योग', 'th': '🏷 อุตสาหกรรม',
  });
