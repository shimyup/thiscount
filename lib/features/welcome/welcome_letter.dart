...
/// "Welcome letter" — a curated, pre-delivered letter from the Letter Go
...
// Letter Go HQ fictional origin — Seoul coordinates (brand home).
...
const Map<String, String> _teamName = {
  'ko': 'Letter Go 팀',
  'en': 'The Letter Go Team',
  'ja': 'Letter Go チーム',
  'zh': 'Letter Go 团队',
  'fr': "L'équipe Letter Go",
  'de': 'Das Letter Go Team',
  'es': 'El equipo de Letter Go',
  'pt': 'A equipe Letter Go',
  'ru': 'Команда Letter Go',
  'tr': 'Letter Go Ekibi',
  'ar': 'فريق Letter Go',
  'it': 'Il team Letter Go',
  'hi': 'Letter Go टीम',
  'th': 'ทีม Letter Go',
};
...
Letter Go에 오신 걸 환영해요. 이 편지는 지구 반대편까지 천천히 여행하는 편지의 첫 번째 도착이에요.
...
Letter Goへようこそ。この手紙は、地球をゆっくり旅してきた最初の到着です。
...
欢迎来到 Letter Go。这封信是你信箱里的第一封——一封慢慢穿越地球来到你身边的信。
