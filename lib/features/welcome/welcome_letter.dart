...
Voici le premier message à arriver dans votre wallet — il a traversé le monde lentement, pour vous.
...
Dies ist die erste Nachricht in deiner Wallet — sie ist langsam um die halbe Welt gereist.
...
Este es el primer mensaje que llega a tu wallet — un mensaje que ha cruzado el mundo lentamente, solo para ti.
...
Esta é a primeira mensagem a chegar à sua wallet — uma mensagem que atravessou o mundo devagar, só para você.
...
Questo è il primo messaggio ad atterrare nel tuo wallet — ha attraversato il mondo lentamente, solo per te.
